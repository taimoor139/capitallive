                                ...
                                <form class="auth-reset-password-form mt-2" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                                <input id="email" type="email" class="form-control form-control-merge" @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                            @error('email')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            ...
                                            <input id="password" type="password" class="form-control form-control-merge"
