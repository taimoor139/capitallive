                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}"
                                  id="registerForm">
                                @csrf
                                <input type="hidden" name="register_type" value="{{ \App\Models\User::NORMAL_USER }}">
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{ (isset($referrer) ? $referrer:'capitalfirst')}}" autocomplete="sponsor" {{ (isset($referrer) ? "readonly":"") }}>
                                    @error('sponsor')
                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <button class="btn btn-primary btn-block signup" tabindex="5">Sign up</button>
                            </form>
