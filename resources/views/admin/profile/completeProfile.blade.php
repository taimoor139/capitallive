...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="../../../img/1.jpg"
        ...
        <div class="form-wrapper">
            ...
            <h4 class="card-title mb-1">Almost there...</h4>
            <p class="card-text mb-2">Please complete your profile to gain access</p>

            <form class="cmn-form mt-30" method="POST"
                  action="{{ route('saveUserData') }}">
                @csrf
                <input type="hidden" value="{{ Auth::user()->id }}" name="user_id">
                <div class="form-group">
                    <label for="full_name" class="form-label">Full Name</label>
                    <input type="text" class="form-control" name="full_name" id="full_name" required
                           autocomplete="full_name" value="{{ Auth::user()->name }}" readonly/>
                    @error('full_name')
                ...
                <div class="form-group">
                    <label for="tax_country" class="form-label">I pay taxes in</label>
                    <select id="tax_country" class="form-control" name="tax_country" required>
                        <option value="">Select country</option>
                        <option value="Afganistan">Afghanistan</option>
                        <option value="Albania">Albania</option>
                        <option value="Algeria">Algeria</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="tax_identification_number" name="tax_identification_number" value="" class="form-control" placeholder="Enter Tax Identification Number (optional)">
                </div>
                <div class="form-group">
                    <label for="Job" class="col-form-label">Terms &amp; Conditions</label>
                    <div class="container">
                        <input class="form-check-input" name="terms" type="checkbox" value="1" id="acceptTerms" required>
                        <label class="form-check-label" for="acceptTerms">I have read and accept the
                            Terms and Conditions of the Customer
                            Agreement, Company Policies and Operative Agreements, Privacy Policy,
                            Risk Acknowledgement and Disclaimer, Refer a Friend Program. I also
                            acknowledge and consent to the processing of my personal data in
                            accordance to the TokyoSecurities.com Personal Data Processing
                            Declaration. <a href="#">terms and conditions</a></label>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary btn-block" tabindex="4">Save Changes</button>
            </form>
        </div>
    </div><!-- login-area end -->
</div>
