            ...
            <div class="uk-grid">
                <div class="uk-width-1-1 uk-flex uk-flex-center">
                    <div class="uk-width-3-5@m uk-text-center">
                        <h1 class="uk-margin-medium-bottom"><span
                                class="in-highlight">About Us</span>
                        </h1>
                        <p class="uk-text-lead uk-text-muted uk-margin-remove-top">Putting our clients first since 2005.
    ...
    <div class="uk-section">
        <div class="uk-container">
            <div class="uk-grid uk-flex uk-flex-center">
                <div class="uk-width-12-12@m">
                    <div class="uk-grid uk-flex uk-flex-middle" data-uk-grid>
                        <div class="uk-width-1-2@m">
                            <h3 class="uk-margin-medium-bottom"><span class="underline-headings">What we do?</span>
                            </h3>
                            ...
                            <div class="offers-section">
                                <img src="{{ asset('img/instawallet.svg') }}">
                                <h3 class="underline-headings uk-margin-small-left">Daily Earning</h3>
                            </div>

                            <div class="offers-section">
                                <img src="{{ asset('img/instabudget.svg') }}">
                                <h3 class="underline-headings uk-margin-small-left">Easy Deposit</h3>
                            </div>

                            <div class="offers-section">
                                <img src="{{ asset('img/instapay.svg') }}">
                                <h3 class="underline-headings uk-margin-small-left">Easy Withdrawal</h3>
                            </div>
                            <div class="offers-section">
                                <img src="{{ asset('img/instacash.svg') }}">
                                <h3 class="underline-headings uk-margin-small-left">Transparent Return Policy</h3>
                            </div>
                        </div>
                        <div class="uk-width-1-2@m">
                            <img src="{{ asset('img/aboutUs.svg') }}" class="team-about-us">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="uk-container">
            <div class="uk-grid">
                <div class="uk-width-1-1 uk-flex uk-flex-center">
                    <div class="uk-width-3-5@m uk-text-center">
                        <h1><span
                                class="in-highlight">About CEO</span>
                        </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-width-4-12@m">
                    <div class="uk-grid uk-flex uk-flex-middle" data-uk-grid>
                        <div class="uk-width-1-3@m">
                            <img src="{{ asset('img/ceo.jpeg') }}" class="ceo-about-us">
                        </div>
                        <div class="uk-width-1-2@m">
                            <h3><b>Enzo Carson</b></h3>
                            <p>
                                Born in London, England , United Kingdom.
                                Co-founder of 4X Capital LLC. This brand now serve over three million customers in 26
                                countries.His mission is to inspire others to dream more, learn more, do more, and
                                become the best versions of themselves.</p>

                            <a href="https://instagram.com/enzocarson7?r=nametag">
                                <img src="{{ asset('img/insta.svg') }}">
                            </a>
                        </div>
        ...
        <div class="uk-container">
            <div class="uk-grid">
                <div class="uk-width-1-1 uk-flex uk-flex-center">
                    <div class="uk-width-3-5@m uk-text-center">
                        <h1 class="uk-margin-medium-bottom"><span
                                class="in-highlight">Affiliation</span>
                        </h1>

                        <p class="uk-text-lead uk-text-muted uk-margin-remove-top">We are Officially Registered  with FSA Of SVG.</p>

                        <div>
                            <img src="{{ asset('img/certificate.jpg') }}" alt="certificate" style="width: 300px !important">
                        </div>
                    </div>
                </div>
            </div>
